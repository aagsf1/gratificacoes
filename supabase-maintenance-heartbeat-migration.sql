...
begin
  ...
  -- Chamadas autenticadas podem ser executadas sob demanda, sem intervalo mínimo.
  -- Cada chamada registra sua própria execução; o agendamento fica no GitHub Actions.
