...
assert.deepEqual([csjt.previous.totals.count, csjt.previous.totals.linked, csjt.previous.totals.unlinked], [52, 45, 7]);
assert.equal(fromDecimal4(csjt.previous.totals.paid4).toFixed(4), "576889.3505");
